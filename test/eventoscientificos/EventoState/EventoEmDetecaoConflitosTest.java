...
/**
 * Testa a classe EventoEmDetecaoConflitos
 *
 * @author G01
 */
public class EventoEmDetecaoConflitosTest {
    ...
    /**
     * Constroi instancia de EventoEmDetecaoConflitos recebendo uma instancia de
     * evento
     */
    public EventoEmDetecaoConflitosTest() {
        this.e = new Evento("titulo", "descricao", new Local("local"),
                            ...
                            new Data(2017, 6, 10));
        e.setEstado(new EventoEmDetecaoConflitos(e));
    }

    /**
     * Teste do metodo setCriado, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setRegistado, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setCPDefinida, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setEmSubmissao, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setEmDetecao, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setEmLicitacao, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setEmDistribuicao, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setEmRevisao, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setFaseDecisao, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste do metodo setCameraReady, da classe EventoEmDetecaoConflitos.
     */
    @Test
    ...
    /**
     * Teste ao metodo valida, da classe EventoEmDetecaoConflitos.
     */
    @Test
